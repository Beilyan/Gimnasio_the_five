...
{{-- INICIO DE FOTOS --}}
    ...
    <div class="profile-cover shadow position-relative mt-3">
        ...
        <div style="max-width: 530px; margin: auto;" class="mb-4">
            <div class="ratio ratio-16x9">
                <iframe src="https://www.youtube.com/embed/0XL4cZR2Ink"></iframe>
            </div>
        </div>  
    ...
    <div class="profile-info bg-white p-4 shadow">
            <div class="ms-4 mt-3 mt-md-0 text-center">
                <h2 class="fw-bold mb-2">Peso muerto con barra: Uno de los mejores ejercicios</h2>
            </div>
    </div>
{{-- FIN DE FOTOS --}}
    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-warning text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>1.- Párate con los pies bajo la barra, separados al ancho de las caderas. Cuando miras cara abajo, la barra debe correr hasta la mitad de tus pies.<br><br>
2.- Inclínate y sujeta la barra con un agarre del ancho de los hombros.<br><br>
3.- Levanta un tanto las caderas, estira la espalda y también inclínate hacia atrás a fin de que el torso quede derecho.</h3>
                </div>
            </div>
        </div>
    </div>
