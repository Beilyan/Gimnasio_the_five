...
{{-- INICIO DE FOTOS --}}
    ...
    <div class="profile-cover shadow position-relative mt-3">
        ...
        <div style="max-width: 530px; margin: auto;" class="mb-4">
            <div class="ratio ratio-16x9">
                <iframe src="https://www.youtube.com/embed/Xgd3PQndqCI"></iframe>
            </div>
        </div>  
    ...
    <div class="profile-info bg-white p-4 shadow">
            <div class="ms-4 mt-3 mt-md-0 text-center">
                <h2 class="fw-bold mb-2">Flexiones con toque de pecho</h2>
            </div>
    </div>
{{-- FIN DE FOTOS --}}
    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-warning text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>1.- Comienza en la posición de plancha alta con las manos ligeramente más anchas que los hombros y los dedos de los pies juntos.<br><br>
2.- Baja lentamente tu cuerpo hasta que el pecho toque el suelo.<br><br>
3.- Empuja hacia arriba hasta volver a la posición inicial de plancha alta<br><br>
4.- Levanta tus manos del suelo y colócalas a cada lado del pecho.</h3>
                </div>
            </div>
        </div>
    </div>
