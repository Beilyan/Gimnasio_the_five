    ...
    <div class="profile-cover shadow position-relative mt-3">
        ...
        <div style="max-width: 530px; margin: auto;" class="mb-4">
            <div class="ratio ratio-16x9">
                <iframe src="https://www.youtube.com/embed/6auqzzewE_8"></iframe>
            </div>
        </div>  
    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-warning text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>1.- Siéntate en un banco plano con una mancuerna en cada mano.<br><br>
2.- Levanta una mancuerna hasta que tu brazo esté completamente extendido por encima de tu hombro y la mancuerna esté justo por encima de tu cabeza.<br><br>
3.- Baja lentamente la mancuerna hacia tu hombro mientras mantienes el brazo en línea recta.<br><br>
4.- Repite con la otra mano y continúa alternando entre los brazos.</h3>
                </div>
            </div>
        </div>
    </div>
