...
{{-- INICIO DE FOTOS --}}
    ...
    <div class="profile-cover shadow position-relative mt-3">
        ...
        <div style="max-width: 530px; margin: auto;" class="mb-4">
            <div class="ratio ratio-16x9">
                <iframe src="https://www.youtube.com/embed/fNsxKTKfMNI"></iframe>
            </div>
        </div>  
    ...
    <div class="profile-info bg-white p-4 shadow">
            <div class="ms-4 mt-3 mt-md-0 text-center">
                <h2 class="fw-bold mb-2">Plancha lateral</h2>
            </div>
    </div>
{{-- FIN DE FOTOS --}}
    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-warning text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>1.- Comienza en posición de plancha con los brazos extendidos y las manos debajo de los hombros.<br><br>
2.- Gira el cuerpo hacia un lado, apoyando el peso en un antebrazo y los pies. El cuerpo debe estar en línea recta desde los hombros hasta los pies.<br><br>
3.- Mantén la posición durante 30 segundos o más, luego regresa a la posición inicial.<br><br>
4.- Repite en el otro lado.</h3>
                </div>
            </div>
        </div>
    </div>
