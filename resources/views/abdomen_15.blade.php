    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-light text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>Acuéstate boca arriba con los brazos y las piernas extendidos hacia arriba.
Levanta el torso del suelo y lleva las manos hacia los tobillos mientras doblas las rodillas hacia el pecho.
Mantén la posición durante unos segundos mientras contraes los abdominales.
Baja lentamente las piernas y los brazos de vuelta a la posición inicial.</h3>
                </div>
            </div>
        </div>
    </div>
