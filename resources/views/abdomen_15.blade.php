...
{{-- INICIO DE FOTOS --}}
    ...
    <div class="profile-cover shadow position-relative mt-3">
        ...
        <div style="max-width: 530px; margin: auto;" class="mb-4">
            <div class="ratio ratio-16x9">
                <iframe src="https://www.youtube.com/embed/Jy1I3Cm_s7E"></iframe>
            </div>
        </div>  
    ...
    <div class="profile-info bg-white p-4 shadow">
            <div class="ms-4 mt-3 mt-md-0 text-center">
                <h2 class="fw-bold mb-2">Cocoons</h2>
            </div>
    </div>
{{-- FIN DE FOTOS --}}
    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-warning text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>1.- Acuéstate boca arriba con los brazos y las piernas extendidos hacia arriba.<br><br>
2.- Levanta el torso del suelo y lleva las manos hacia los tobillos mientras doblas las rodillas hacia el pecho.<br><br>
3.- Mantén la posición durante unos segundos mientras contraes los abdominales.<br><br>
4.- Baja lentamente las piernas y los brazos de vuelta a la posición inicial.</h3>
                </div>
            </div>
        </div>
    </div>
