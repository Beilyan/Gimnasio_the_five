    ...
    <div class="profile-cover shadow position-relative mt-3">
        ...
        <div style="max-width: 530px; margin: auto;" class="mb-4">
            <div class="ratio ratio-16x9">
                <iframe src="https://www.youtube.com/embed/C7Nq4DgV9Mg"></iframe>
            </div>
        </div>  
    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-warning text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>1.- Acuéstate en un banco plano con una mancuerna en cada mano.<br><br>
2.- Mantén los brazos ligeramente doblados y las mancuernas cerca del pecho.<br><br>
3.- Separa los brazos en un movimiento suave y controlado, manteniendo una ligera flexión en los codos.<br><br>
4.- Lleva los brazos hacia atrás y luego vuelve a la posición inicial.<br><br>5.- Haz las repeticiones que indique tu plan de entrenamiento.</h3>
                </div>
            </div>
        </div>
    </div>
