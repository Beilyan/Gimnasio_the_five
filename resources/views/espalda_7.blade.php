...
{{-- INICIO DE FOTOS --}}
    ...
    <div class="profile-cover shadow position-relative mt-3">
        ...
        <div style="max-width: 530px; margin: auto;" class="mb-4">
            <div class="ratio ratio-16x9">
                <iframe src="https://www.youtube.com/embed/sQ-APCL4g8o"></iframe>
            </div>
        </div>  
    ...
    <div class="profile-info bg-white p-4 shadow">
            <div class="ms-4 mt-3 mt-md-0 text-center">
                <h2 class="fw-bold mb-2">Remo sentado en polea con agarre abierto</h2>
            </div>
    </div>
{{-- FIN DE FOTOS --}}
    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-warning text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>1.- Siéntate frente a una polea con la espalda recta y los pies apoyados en los pedales.<br><br>
2.- Agarra la barra con las palmas hacia abajo y los brazos extendidos.<br><br>
3.- Tirando de los codos hacia atrás, lleva la barra hacia tu pecho y aprieta los omóplatos.<br><br>
4.- Vuelve lentamente a la posición inicial y repite.</h3>
                </div>
            </div>
        </div>
    </div>
