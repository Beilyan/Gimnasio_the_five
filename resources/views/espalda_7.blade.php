    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-light text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>Siéntate frente a una polea con la espalda recta y los pies apoyados en los pedales.
Agarra la barra con las palmas hacia abajo y los brazos extendidos.
Tirando de los codos hacia atrás, lleva la barra hacia tu pecho y aprieta los omóplatos.
Vuelve lentamente a la posición inicial y repite.</h3>
                </div>
            </div>
        </div>
    </div>
