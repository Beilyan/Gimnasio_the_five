...
{{-- INICIO DE FOTOS --}}
    ...
    <div class="profile-cover shadow position-relative mt-3">
        ...
        <div style="max-width: 530px; margin: auto;" class="mb-4">
            <div class="ratio ratio-16x9">
                <iframe src="https://www.youtube.com/embed/68b1DMboAes"></iframe>
            </div>
        </div>  
    ...
    <div class="profile-info bg-white p-4 shadow">
            <div class="ms-4 mt-3 mt-md-0 text-center">
                <h2 class="fw-bold mb-2">Curl agarre prono con mancuernas</h2>
            </div>
    </div>
{{-- FIN DE FOTOS --}}
    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-warning text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>1.- Agarra una mancuerna en cada mano con las palmas hacia abajo y los brazos extendidos.<br><br>
2.- Inhala y dobla los codos para levantar las mancuernas hacia los hombros mientras exhalas.<br><br>
3.- Mantén la posición por un momento y luego baja lentamente las mancuernas de nuevo a la posición inicial.<br><br>
4.- Repite el ejercicio durante el número deseado de repeticiones.</h3>
                </div>
            </div>
        </div>
    </div>
