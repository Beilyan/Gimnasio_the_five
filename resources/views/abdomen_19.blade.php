...
{{-- INICIO DE FOTOS --}}
    ...
    <div class="profile-info bg-white p-4 shadow">
            <div class="ms-4 mt-3 mt-md-0 text-center">
                <h2 class="fw-bold mb-2">Abdominales cruzados</h2>
            </div>
    </div>
{{-- FIN DE FOTOS --}}
    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-light text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>Lo primero que debes hacer es acostarte boca arriba, doblar así tus rodillas a aproximadamente 60 grados.
Luego vas a colocar los pies planos en el piso, luego coloca las manos sueltas sobre la cabeza. Procede a traer tu codo y hombro derecho, a través de tu cuerpo, al mismo tiempo comenzaras a mover la rodilla izquierda hacia el hombro izquierdo. Asegúrate de intentar tocarte la rodilla con el codo, seguidamente exhala mientras lo vas haciendo.
Luego vuelve a la posición inicial e inhalaras mientras lo vas haciendo, repetirás el movimiento, pero con el codo izquierdo y la rodilla derecha.
Sigue alternando esos movimientos, hasta que completes el número de repeticiones.</h3>
                </div>
            </div>
        </div>
    </div>
