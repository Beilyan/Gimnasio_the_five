    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-light text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>Acuéstate boca arriba y estira tus brazos sobre tu cabeza. Mantén tus piernas rectas y juntas.
Levanta tus piernas y hombros del suelo, manteniéndolos a unos centímetros del suelo.
Mantén tu espalda plana contra el suelo y aprieta tus abdominales para mantener la posición.
Mantén esta posición durante 30 segundos o más y luego descansa.</h3>
                </div>
            </div>
        </div>
    </div>
