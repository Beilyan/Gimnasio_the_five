...
{{-- INICIO DE FOTOS --}}
    ...
    <div class="profile-cover shadow position-relative mt-3">
        ...
        <div style="max-width: 530px; margin: auto;" class="mb-4">
            <div class="ratio ratio-16x9">
                <iframe src="https://www.youtube.com/embed/YHBp6fvXYcI"></iframe>
            </div>
        </div>  
    ...
    <div class="profile-info bg-white p-4 shadow">
            <div class="ms-4 mt-3 mt-md-0 text-center">
                <h2 class="fw-bold mb-2">Hollow Hold</h2>
            </div>
    </div>
{{-- FIN DE FOTOS --}}
    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-warning text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>1.- Acuéstate boca arriba y estira tus brazos sobre tu cabeza. Mantén tus piernas rectas y juntas.<br><br>
2.- Levanta tus piernas y hombros del suelo, manteniéndolos a unos centímetros del suelo.<br><br>
3.- Mantén tu espalda plana contra el suelo y aprieta tus abdominales para mantener la posición.<br><br>
4.- Mantén esta posición durante 30 segundos o más y luego descansa.</h3>
                </div>
            </div>
        </div>
    </div>
