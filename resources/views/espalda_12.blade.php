...
{{-- INICIO DE FOTOS --}}
    ...
    <div class="profile-info bg-white p-4 shadow">
            <div class="ms-4 mt-3 mt-md-0 text-center">
                <h2 class="fw-bold mb-2">Remo con barra landmine (agarre V)</h2>
            </div>
    </div>
{{-- FIN DE FOTOS --}}
    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-warning text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>1.- Comienza sosteniendo la barra con un agarre en forma de V y asegurándola en un soporte landmine.<br><br>
2.- Ponte de pie con las piernas separadas a la altura de los hombros, manteniendo una ligera flexión en las rodillas y la espalda recta.<br><br>
3.- Tira de la barra hacia tu cuerpo, llevando los codos hacia atrás y manteniendo los hombros hacia abajo y hacia atrás.<br><br>
4.- Mantén la contracción durante un segundo y luego baja lentamente la barra hacia la posición inicial.</h3>
                </div>
            </div>
        </div>
    </div>
