...
{{-- INICIO DE FOTOS --}}
    ...
    <div class="profile-info bg-white p-4 shadow">
            <div class="ms-4 mt-3 mt-md-0 text-center">
                <h2 class="fw-bold mb-2">Remo sentado en polea baja (agarre V)</h2>
            </div>
    </div>
{{-- FIN DE FOTOS --}}
    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-light text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>Siéntese en la máquina de polea baja y agarre la barra V.
Enderece la espalda y deslice los glúteos hacia atrás. El cable ha de estar tenso y los brazos y los hombros han de estar estirados hacia adelante.Sosteniendo los codos cerca de su cuerpo, tire de la barra hacia su abdomen mientras exhala.
...
Repetir de acuerdo a tu plan.</h3>
                </div>
            </div>
        </div>
    </div>
