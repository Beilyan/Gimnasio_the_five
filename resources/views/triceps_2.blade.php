    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-light text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>Ponte de pie con los pies separados al ancho de los hombros y sostén una mancuerna con ambas manos detrás de la cabeza, con los codos doblados y las palmas hacia arriba.
Levanta la mancuerna hacia arriba y extiende los brazos completamente.
Baja lentamente la mancuerna detrás de la cabeza hasta que los codos estén doblados a 90 grados.
Repite el movimiento para completar la serie.</h3>
                </div>
            </div>
        </div>
    </div>
