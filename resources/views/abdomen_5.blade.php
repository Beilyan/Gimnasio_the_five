...
{{-- INICIO DE FOTOS --}}
    ...
    <div class="profile-cover shadow position-relative mt-3">
        ...
        <div style="max-width: 530px; margin: auto;" class="mb-4">
            <div class="ratio ratio-16x9">
                <iframe src="https://www.youtube.com/embed/kUGXWrNgVLQ"></iframe>
            </div>
        </div>  
    ...
    <div class="profile-info bg-white p-4 shadow">
            <div class="ms-4 mt-3 mt-md-0 text-center">
                <h2 class="fw-bold mb-2">Plancha de rodillas</h2>
            </div>
    </div>
{{-- FIN DE FOTOS --}}
    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-warning text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>1.- Comienza en posición de cuatro patas, con las rodillas en el suelo y las manos directamente debajo de los hombros.<br><br>
2.- Estira las piernas hacia atrás y mantén los dedos de los pies en el suelo.<br><br>
3.- Asegúrate de que tu cuerpo esté en línea recta desde la cabeza hasta los talones.<br><br>
4.- Mantén la posición durante 20 a 30 segundos, respirando profundamente.</h3>
                </div>
            </div>
        </div>
    </div>
