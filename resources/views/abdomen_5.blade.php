    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-light text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>Comienza en posición de cuatro patas, con las rodillas en el suelo y las manos directamente debajo de los hombros.
Estira las piernas hacia atrás y mantén los dedos de los pies en el suelo.
Asegúrate de que tu cuerpo esté en línea recta desde la cabeza hasta los talones.
Mantén la posición durante 20 a 30 segundos, respirando profundamente.</h3>
                </div>
            </div>
        </div>
    </div>
