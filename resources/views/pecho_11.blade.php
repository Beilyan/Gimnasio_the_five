...
{{-- INICIO DE FOTOS --}}
    ...
    <div class="profile-cover shadow position-relative mt-3">
        ...
        <div style="max-width: 530px; margin: auto;" class="mb-4">
            <div class="ratio ratio-16x9">
                <iframe src="https://www.youtube.com/embed/cS8veW3C3DE"></iframe>
            </div>
        </div>  
    ...
    <div class="profile-info bg-white p-4 shadow">
            <div class="ms-4 mt-3 mt-md-0 text-center">
                <h2 class="fw-bold mb-2">Flexiones a una mano</h2>
            </div>
    </div>
{{-- FIN DE FOTOS --}}
    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-warning text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>1.- Comienza en posición de plancha con las manos separadas al ancho de los hombros.<br><br>
2.- Separa los pies para tener una base sólida y coloca una mano detrás de la espalda.<br><br>
3.- Baja el cuerpo lentamente, manteniendo el codo pegado al costado.<br><br>
4.- Empuja hacia arriba hasta volver a la posición inicial. Realiza el mismo número de repeticiones en cada lado.</h3>
                </div>
            </div>
        </div>
    </div>
