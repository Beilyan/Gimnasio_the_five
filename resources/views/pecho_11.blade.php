    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-light text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>Comienza en posición de plancha con las manos separadas al ancho de los hombros.
...
Empuja hacia arriba hasta volver a la posición inicial. Realiza el mismo número de repeticiones en cada lado.</h3>
                </div>
            </div>
        </div>
    </div>
