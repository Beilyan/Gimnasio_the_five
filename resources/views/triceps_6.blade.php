    ...
    <div class="profile-cover shadow position-relative mt-3">
        ...
        <div style="max-width: 530px; margin: auto;" class="mb-4">
            <div class="ratio ratio-16x9">
                <iframe src="https://www.youtube.com/embed/Ldq200g_vFU"></iframe>
            </div>
        </div>  
    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-warning text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>1.- Coloca una esterilla en el suelo y colócate en posición de plancha, con los antebrazos y las puntas de los pies apoyados en la esterilla.<br><br>
2.- Mantén el cuerpo recto y los abdominales apretados mientras bajas el cuerpo hacia la esterilla.<br><br>
3.- Empuja hacia arriba con los antebrazos para volver a la posición inicial.<br><br>
