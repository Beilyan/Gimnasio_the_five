...
{{-- INICIO DE FOTOS --}}
    ...
    <div class="profile-cover shadow position-relative mt-3">
        ...
        <div style="max-width: 530px; margin: auto;" class="mb-4">
            <div class="ratio ratio-16x9">
                <iframe src="https://www.youtube.com/embed/E6FcY0rnujk"></iframe>
            </div>
        </div>  
    ...
    <div class="profile-info bg-white p-4 shadow">
            <div class="ms-4 mt-3 mt-md-0 text-center">
                <h2 class="fw-bold mb-2">Elevación de pantorrillas con barra</h2>
            </div>
    </div>
{{-- FIN DE FOTOS --}}
    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-warning text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>1.- Coloca una barra cargada en la parte posterior de tus hombros, sosteniéndola con los brazos detrás de ti.<br><br>
2.- Levanta los talones del suelo y mantén tu equilibrio mientras mantienes la barra en su lugar.<br><br>
3.- Baja lentamente los talones hacia el suelo y repite el movimiento.<br><br>
4.- Realiza 3 series de 12-15 repeticiones.</h3>
                </div>
            </div>
        </div>
    </div>
