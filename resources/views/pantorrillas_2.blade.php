    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-light text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>Coloca una barra cargada en la parte posterior de tus hombros, sosteniéndola con los brazos detrás de ti.
Levanta los talones del suelo y mantén tu equilibrio mientras mantienes la barra en su lugar.
Baja lentamente los talones hacia el suelo y repite el movimiento.
Realiza 3 series de 12-15 repeticiones.</h3>
                </div>
            </div>
        </div>
    </div>
