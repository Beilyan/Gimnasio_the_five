    ...
    <div class="profile-cover shadow position-relative mt-3">
        ...
        <div style="max-width: 530px; margin: auto;" class="mb-4">
            <div class="ratio ratio-16x9">
                <iframe src="https://www.youtube.com/embed/Oy6M5aQPsko"></iframe>
            </div>
        </div>  
    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-warning text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>1.- Coloca la polea en la posición más baja y ajusta el peso deseado.<br><br>
2.- Toma las cuerdas con un agarre neutro (palmas mirándose entre sí).<br><br>
3.- Mantén los codos pegados a los costados y comienza a flexionar los bíceps, manteniendo los antebrazos paralelos al suelo.<br><br>
4.- Continúa levantando las manos hacia los hombros y siente la contracción en los bíceps. Luego, baja las manos lentamente a la posición inicial.
</h3>
                </div>
            </div>
        </div>
