    ...
    <div class="profile-cover shadow position-relative mt-3">
        ...
        <div style="max-width: 530px; margin: auto;" class="mb-4">
            <div class="ratio ratio-16x9">
                <iframe src="https://www.youtube.com/embed/G2j_lJf6ljk"></iframe>
            </div>
        </div>  
    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-warning text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>1.- Siéntate en un banco inclinado con una pesa en cada mano y coloca los pies firmemente en el suelo.<br><br>
2.- Inclina tu cuerpo hacia atrás, manteniendo las pesas sobre tu pecho con los codos ligeramente doblados.<br><br>
3.- Luego, presiona las pesas hacia arriba, asegurándote de juntarlas y apretarlas en el punto más alto del movimiento.<br><br>
4.- Baja las pesas lentamente hasta que los codos estén ligeramente por debajo de los hombros y repite el movimiento.</h3>
                </div>
            </div>
        </div>
    </div>
