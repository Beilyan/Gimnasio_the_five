...
{{-- INICIO DE FOTOS --}}
    ...
    <div class="profile-cover shadow position-relative mt-3">
        ...
        <div style="max-width: 530px; margin: auto;" class="mb-4">
            <div class="ratio ratio-16x9">
                <iframe src="https://www.youtube.com/embed/NKehjTZEc7s"></iframe>
            </div>
        </div>  
    ...
    <div class="profile-info bg-white p-4 shadow">
            <div class="ms-4 mt-3 mt-md-0 text-center">
                <h2 class="fw-bold mb-2">Curl concentrado con mancuerna agarre prono</h2>
            </div>
    </div>
{{-- FIN DE FOTOS --}}
    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-warning text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>1.- Siéntate en un banco con una mancuerna en una mano y el brazo apoyado en el muslo.<br><br>
2.- Con el codo apoyado en la pierna, levanta la mancuerna hacia el hombro manteniendo el codo inmóvil.<br><br>
3.- Haz una pausa en la parte superior y baja lentamente la mancuerna a la posición inicial.<br><br>
4.- Realiza la cantidad deseada de repeticiones y cambia de brazo.
</h3>
                </div>
            </div>
        </div>
