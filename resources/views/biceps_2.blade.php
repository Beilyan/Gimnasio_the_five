...
{{-- INICIO DE FOTOS --}}
    ...
    <div class="profile-info bg-white p-4 shadow">
            <div class="ms-4 mt-3 mt-md-0 text-center">
                <h2 class="fw-bold mb-2">Curl predicador a una mano con mancuerna</h2>
            </div>
    </div>
{{-- FIN DE FOTOS --}}
    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-light text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>Siéntate en un banco de predicador y agarra una mancuerna con una mano, manteniendo la palma hacia arriba y el codo apoyado en el cojín del banco.ç
Contrae el bíceps y levanta la mancuerna hacia el hombro, manteniendo el codo en su lugar en el cojín del banco.
