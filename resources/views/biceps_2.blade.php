    ...
    <div class="profile-cover shadow position-relative mt-3">
        ...
        <div style="max-width: 530px; margin: auto;" class="mb-4">
            <div class="ratio ratio-16x9">
                <iframe src="https://www.youtube.com/embed/9CvOxO1ndLc"></iframe>
            </div>
        </div>  
    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-warning text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>1.- Siéntate en un banco de predicador y agarra una mancuerna con una mano, manteniendo la palma hacia arriba y el codo apoyado en el cojín del banco.<br><br>
2.- Contrae el bíceps y levanta la mancuerna hacia el hombro, manteniendo el codo en su lugar en el cojín del banco.<br><br>
3.- Baja la mancuerna lentamente a la posición inicial.<br><br>
