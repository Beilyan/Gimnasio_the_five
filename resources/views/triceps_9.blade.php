    ...
    <div class="row g-3">
        <div class="col-md-12">
            <div class="bg-light text-black p-4 rounded-4 d-flex aling-items-center">
                <div>
                    <h3>Comienza de pie frente a la polea de cable y asegura un agarre recto en la cuerda de la polea con ambas manos.
Levanta las manos hacia arriba y hacia atrás, detrás de la cabeza, manteniendo los codos cerca de las orejas.
Extiende los brazos hacia abajo en línea recta hasta que estén completamente rectos.
Regresa lentamente a la posición inicial manteniendo el control de la cuerda y manteniendo los codos cerca de las orejas.</h3>
                </div>
            </div>
        </div>
    </div>
